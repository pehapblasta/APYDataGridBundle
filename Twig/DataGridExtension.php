 ...
 */
class DataGridExtension extends Extension implements GlobalsInterface
{
    ...
    protected function getTemplates(Environment $environment)
    {
        if (empty($this->templates)) {
            if ($this->theme instanceof Template) {
                ...
                $this->templates[] = $environment->loadTemplate($this->defaultTemplate, $this->defaultTemplate);
    ...
    protected function getTemplatesFromString(Environment $environment, $theme)
    {
        ...
        $template = $environment->loadTemplate($theme, $theme);
